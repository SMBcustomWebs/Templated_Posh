...
<!-- global settings - colors, fonts, logos, addresses, names, taglines,metadata -->
<cms:template title="Global Site Settings" parent='_global_'  icon='globe' hidden="0" order="90" >
	...
	<cms:pagebuilder name='ccs_gl_tpb_pb' label='Optional Top Bar' skip_custom_fields='1' order='4'>
        <cms:section label='Optional Top Bar' name='ccs_gl_tpb_sect'  masterpage='blocks/frame/top_bar.php' mosaic='ccs_tpb_msc' />
    </cms:pagebuilder>
    ...
    <cms:editable type='group' name='ccs_gl_site_biz_grp' label='Website Business Settings' desc='logo, site name, tagline, color theme, favicon' collapsed='1' order='9'>
        ...
        <cms:editable type='row' name='ccs_gl_site_tgl_row'  order='10' >
            ...
            <cms:editable type='message' name='nca_cntnt_2col_img_br' class='col-md-12'  order='7' >
                <br><hr>
            </cms:editable>            <cms:editable type='dropdown' name='ccs_gl_tgln_fnt_fm' label='Tagline Font Family' 
    ...
    <cms:editable type='group' name='ccs_gl_site_cntc_grp' label='Website Contact Settings' order='15'>
        ...
        <cms:editable type='text' name='ccs_gl_hdqt_st_add' label='Headquarter Street Address'  desc=''
            order='2' 
        />
        <cms:editable type='text' name='ccs_gl_hdqt_st_ad2' label='Headquarter Suite'  desc='optional'
            order='4' 
        />
        <cms:editable type='text' name='ccs_gl_hdqt_cty' label='Headquarter City'  desc=''
            order='6' 
        />
        <cms:editable type='text' name='ccs_gl_hdqt_sta' label='Headquarter State'  desc=''
            order='8' 
        />
        <cms:editable type='text' name='ccs_gl_hdqt_zip' label='Headquarter Zip'  desc=''
            order='10' 
        />
        <cms:editable type='text' name='ccs_gl_hdqt_ggl_lnk' label='Google Map Link'  desc='for address link to show Google Map'
            order='12' 
        />
        <cms:editable type='text' name='ccs_gl_hdqt_email' label='Public Email'  desc=''
            order='14' 
        />
        ...
        <cms:repeatable name='ccs_gl_hdqt_pho_rpt' label='Public Phone Numbers' desc='one number per row' order='18' >    
            <cms:editable type='text' name='ccs_gl_hdqt_pho_fa_icon' label='Phone Icon'
                width='140'
                order='2' 
            />
            <cms:editable type='text' name='ccs_gl_hdqt_pho' label='Phone Number'
                width='230'
                order='4' 
            />
        </cms:repeatable>
        <cms:editable type='text' name='ccs_gl_hdqt_fax' label='Public Fax'  desc=''
            order='20' 
        />
        ...
        <cms:repeatable name='ccs_gl_ggl_maps_rpt' label='Location Google Map Links' desc='one map per row' order='26' > 
            <cms:editable type='text' name='ccs_gl_hdqt_map_fa_icon' label='Map Icon'
                width='140'
                order='2' 
            />
            <cms:editable type='textarea' name='ccs_gl_ggl_map_embed' label='Google Map Embed - Full url embed code'
                order='4' 
            />
            <cms:editable type='text' name='ccs_gl_ggl_map_link' label='Google Map Link - Full url link'  desc=''
                order='6' 
            />
        </cms:repeatable>
    </cms:editable>
    <cms:editable type='group' name='ccs_gl_site_scl_grp'  label='Website Social Media Settings' order='18'>
        ...
        <cms:editable type='text' name='ccs_gl_andr_app' label='Android App Link'  desc=''
            order='6' 
        />
            <cms:editable type='text' name='ccs_gl_appl_app' label='Apple App Link'  desc=''
                order='8' 
        />
    </cms:editable>
    ...
    <!-- fuctions to turn on or off customized colors -->
    ...
    <!-- fuctions to turn on or off customized fonts -->
    ...
    <body>
        <div class="container">
            <div class="align-items-center">
                ...
                <cms:popup_edit 'ccs_gl_site_name_txt_lgo_opt|ccs_gl_site_name|ccs_gl_site_name_txt_clr|ccs_gl_site_name_txt_sz|ccs_gl_site_biz_mta_row|ccs_gl_tgln|ccs_gl_tgln_opt'  link_text="<button class='btn btn-xl btn-primary font-' title='Color: Primary Font-Family: Default  Click to edit Website Name and Tagline'><p>Edit Site Name and tagline</p></button>"  />
                <cms:popup_edit 'ccs_gl_site_desc_msg|ccs_gl_site_desc' link_text="<button class='ms-2 btn btn-xl btn-success font-sans-serif' title='Color:Success Font-Family: Sans Serif  Click to edit SEO Meta data'><p>Edit SEO Site Description</p></button>"  />
                <cms:popup_edit 'ccs_gl_site_biz_lgo_msg|ccs_gl_site_logo|ccs_gl_site_favicon' link_text="<button class='ms-2 btn btn-xl btn-secondary font-base' title='Color: Secondary Font-Family: Base  Click to edit Logo'><p>Set Brand Logos</p></button>"  />
                <cms:popup_edit 'ccs_gl_hdqt_st_add|ccs_gl_hdqt_st_ad2|ccs_gl_hdqt_cty|ccs_gl_hdqt_sta|ccs_gl_hdqt_zip|ccs_gl_hdqt_email|ccs_gl_cntct_pho_msg|ccs_gl_hdqt_pho_rpt|ccs_gl_hdqt_fax|ccs_gl_cntct_map_msg|ccs_gl_ggl_maps_rpt' link_text="<hr class=''><button class='btn btn-xl btn-info font-serif' title='Color: Info  Font-Family: Serif  Click to edit Busines Main Contact Information'><p>Edit Site Contact Settings</p></button>"  />

                <cms:popup_edit 'ccs_gl_site_scl_grp|ccs_gl_social_msg|ccs_gl_social' link_text="<button class='ms-2 btn btn-xl btn-warning font-monospace' title='Color: Warning Font-Family: Monospace  Click to edit Website Social Links'><p>Edit Site Social Media</p></button>"  />
                ...
                <p>Select/highlight these words to display the SELECT colors.<b>**</b></p><p> The below button colors below display the current settings for the extra theme colors and font-families. Hover mouse over buttons to see more info.</p>
                ...
                <cms:popup_edit 'ccs_gl_site_biz_lgo_row|ccs_gl_site_thm_opt|ccs_gl_site_custom_color_opt|ccs_gl_site_site_cst_clr_grp|ccs_gl_site_body_clr_cust|ccs_gl_site_body_bg_cust' link_text="<button class='btn btn-xl btn-danger font-sans-serif' title='Color: Danger Font-Family: Sans-serif  Click to edit default font, text color and background color'><p><b>*</b> Site text and background color</p></button>"  />
                ...
                <cms:popup_edit 'ccs_gl_site_custom_font_opt|ccs_gl_site_font_size_cust|ccs_gl_site_font_weight_cust|ccs_gl_site_line_height_cust' link_text="<button class='my-3 mx-3 btn btn-xl btn-white font-' title='Color: White Font-Family: Default  Click to set extra font-family looks'><p>Customize Default Font size, Weight, Line-Height Options </p></button><br><hr><br>"  />
                <br><hr class=''><br><hr><br>
