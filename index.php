...
<cms:template title="Homepage" parent='_site_' icon='home' order="90" >
    ...
    <cms:pagebuilder name='home_pb' label='Homepage PageBuilder' skip_custom_fields='1' order='-1'>
        ...
        <cms:section label='Page Hero' name='hro_sect'  masterpage='blocks/hero.php' mosaic='hero_block_msc' />
        <cms:section label='Banner Transition' name='trans_sect'  masterpage='blocks/transitions.php' mosaic='trns_msc' />
        
        <cms:section label='Site Footer' name='ftr_sect'  masterpage='blocks/footer.php' mosaic='footer_msc' />
