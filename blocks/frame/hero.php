...
<cms:template title='Stock Invetory:: Page Heros' parent='_frame_' icon='cog' clonable='0'  order='300' >
    <cms:mosaic name='hero_block_msc' label='Hero Block' body_class='_pb'>
        <cms:tile name='hero_single_img_tile' label='Hero - Single Image Background' _pb_template='hero/theme/hero_single_img' _pb_height='350'>
             ...
             <cms:embed 'pb_mods/hero/embed/hero_c2a.htm' />
             <cms:embed 'pb_mods/hero/embed/hero_modal-add.htm' />
             <cms:embed 'pb_mods/hero/embed/hero_btm_rail.htm' />
        </cms:tile>
        <cms:tile name='hero_single_vid_tile' label='Hero - Single Video Background' _pb_template='hero/theme/hero_single_vid' _pb_height='350'>
             <cms:embed 'pb_mods/hero/embed/hero_format_single.htm' />
             <cms:embed 'pb_mods/hero/embed/hero_bg-img.htm' />
        ...
        <cms:tile name='hero_swiper_img_tile' label='Hero - Image and Video Carousel' _pb_template='hero/theme/hero_swiper-slide' _pb_height='350'>
            <cms:embed 'pb_mods/hero/embed/hero_format_swpr.htm' />
            <cms:embed 'pb_mods/hero/embed/hero_swiper-slide.htm' />

        </cms:tile>

        <cms:tile name='hero_split_tile' label='Hero - Split Sides' _pb_template='' _pb_height='350'>
            

            
        </cms:tile>
        <cms:tile name='hero_offset_tile' label='Hero - Single Image with Offset Element' _pb_template='' _pb_height='350'>
            
 
        </cms:tile>
        <cms:tile name='hero_inst_img' label='w/ Small Inset Image and Title' _pb_template='hero/theme/hero_inst_img' _pb_height='350'>
